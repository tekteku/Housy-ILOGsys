...
Ce rapport est organisé selon les phases de CRISP-DM :

\begin{itemize}
    \item \textbf{Chapitre 1 :} Cadre du projet et contexte
    \item \textbf{Chapitre 2 :} Compréhension métier (Business Understanding)
    \item \textbf{Chapitre 3 :} Compréhension des données (Data Understanding)
    \item \textbf{Chapitre 4 :} Préparation des données (Data Preparation)
    \item \textbf{Chapitre 5 :} Modélisation (Modeling)
    \item \textbf{Chapitre 6 :} Conception et Diagrammes UML
    \item \textbf{Chapitre 7 :} Évaluation (Evaluation)
    \item \textbf{Chapitre 8 :} Déploiement (Deployment)
...
% Pour des raisons de longueur, je vais créer la structure complète dans le prochain message
