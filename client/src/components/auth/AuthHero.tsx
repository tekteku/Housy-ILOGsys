...
export function AuthHero() {
  ...
  // Images de fond rotatives
  const backgroundImages = [
    "/static/images/modern_house_6.png",
    "/static/images/house11.png", 
    "/static/images/modern_house_9.png",
    "/static/images/hous7.png",
    "/static/images/modern_house_4.png"
  ];
  ...
  // Animation des témoignages et images
  useEffect(() => {
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-blue-900 via-blue-800 to-indigo-900 overflow-hidden">
      ...
      {/* Carrousel d'images de fond réelles */}
