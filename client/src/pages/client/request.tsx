...
export default function NewRequestPage() {
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Nouvelle Demande de Projet</h1>
        <p className="text-gray-600">Créez une nouvelle demande de construction en remplissant les informations ci-dessous</p>
      </div>
